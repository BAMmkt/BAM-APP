...
exports.ffPrivateApi = functions
  .region("southamerica-east1")
  .runWith({ minInstances: 1, maxInstances: 10, timeoutSeconds: 120 })
...
exports.ffPrivateApiV2 = onRequest(
  { cors: true, minInstances: 1, maxInstances: 10, timeoutSeconds: 120 },
  async (req, res) => {
    try {
      const context = {
